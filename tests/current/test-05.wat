(module
  ...
  (data (i32.const 0) "#000080\00#800000\00#008000\00Test: Three X's in different colors and thicknesses\00")
  ...
  (func $Fun0 (result i32)
    ...
    (i32.const 390)  ;; Literal value
    (call $drawLine)  ;; Call function Line
    (i32.const 24)  ;; Literal string "Test: Three X's in different colors and thicknesses"
