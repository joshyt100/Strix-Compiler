(module
  ...
  (data (i32.const 0) "orange\00purple\00yellow\00pink\00brown\00gray\00#000080\00#800000\00#008000\00Test: Use global variables to auto-place the next X.\00")
  ...
  (func $Fun1 (result i32)
    (i32.const 0)  ;; Literal string "orange"
    (call $Fun0)  ;; Call function DrawX
    (drop) ;; Result not used.
    (i32.const 7)  ;; Literal string "purple"
    (call $Fun0)  ;; Call function DrawX
    (drop) ;; Result not used.
    (i32.const 14)  ;; Literal string "yellow"
    (call $Fun0)  ;; Call function DrawX
    (drop) ;; Result not used.
    (i32.const 21)  ;; Literal string "pink"
    (call $Fun0)  ;; Call function DrawX
    (drop) ;; Result not used.
    (i32.const 26)  ;; Literal string "brown"
    (call $Fun0)  ;; Call function DrawX
    (drop) ;; Result not used.
    (i32.const 32)  ;; Literal string "gray"
    (call $Fun0)  ;; Call function DrawX
    (drop) ;; Result not used.
    (i32.const 37)  ;; Literal string "#000080"
    (call $Fun0)  ;; Call function DrawX
    (drop) ;; Result not used.
    (i32.const 45)  ;; Literal string "#800000"
    (call $Fun0)  ;; Call function DrawX
    (drop) ;; Result not used.
    (i32.const 53)  ;; Literal string "#008000"
    (call $Fun0)  ;; Call function DrawX
    (drop) ;; Result not used.
    (i32.const 61)  ;; Literal string "Test: Use global variables to auto-place the next X."
