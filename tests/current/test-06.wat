(module
  ...
  (data (i32.const 0) "#000080\00#800000\00#008000\00orange\00purple\00yellow\00pink\00brown\00gray\00Test: Call function to make lots of X's in different sizes, colors and thicknesses\00")
  ...
  (func $Fun1 (result i32)
    ...
    (i32.const 0)  ;; Literal string "#000080"
    ...
    (i32.const 8)  ;; Literal string "#800000"
    (call $Fun0)  ;; Call function DrawX
    (drop) ;; Result not used.
    ...
    (i32.const 16)  ;; Literal string "#008000"
    (call $Fun0)  ;; Call function DrawX
    (drop) ;; Result not used.
    (i32.const 10)  ;; Literal value
    ...
    (i32.const 24)  ;; Literal string "orange"
    (call $Fun0)  ;; Call function DrawX
    (drop) ;; Result not used.
    ...
    (i32.const 31)  ;; Literal string "purple"
    (call $Fun0)  ;; Call function DrawX
    (drop) ;; Result not used.
    (i32.const 210)  ;; Literal value
    (i32.const 300)  ;; Literal value
    (i32.const 80)  ;; Literal value
    (i32.const 4)  ;; Literal value
    (i32.const 38)  ;; Literal string "yellow"
    (call $Fun0)  ;; Call function DrawX
    (drop) ;; Result not used.
    ...
    (i32.const 45)  ;; Literal string "pink"
    (call $Fun0)  ;; Call function DrawX
    (drop) ;; Result not used.
    (i32.const 410)  ;; Literal value
    (i32.const 300)  ;; Literal value
    ...
    (i32.const 50)  ;; Literal string "brown"
    (call $Fun0)  ;; Call function DrawX
    (drop) ;; Result not used.
    ...
    (i32.const 56)  ;; Literal string "gray"
    (call $Fun0)  ;; Call function DrawX
    (drop) ;; Result not used.
