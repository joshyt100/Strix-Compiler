(module
  ...
  (data (i32.const 0) "blue\00#000080\00Test: Blue circle with dark blue perimeter\00")
  ...
  (func $Fun0 (result i32)
    (i32.const 0)  ;; Literal string "blue"
    (call $setFillColor)  ;; Call function FillColor
    (i32.const 5)  ;; Literal string "#000080"
    (call $setStrokeColor)  ;; Call function LineColor
    (i32.const 13)  ;; Literal string "Test: Blue circle with dark blue perimeter"
